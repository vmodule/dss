...
public:
	...
	enum
	{
		...
		kIdleEvent = 0x1 << 0x1, kStartEvent = 0x1 << 0x2, kTimeoutEvent = 0x1
				<< 0x3,
...
public:
	...
	static Bool16 AddThreads(UInt32 numToAdd);
	 // creates the threads: takes NumShortTaskThreads + NumBLockingThreads,  sets num short task threads.
