...
public:
	...
	DateBuffer* GetDateBuffer()
	{
		return &fDateBuffer;
	}

	static void* GetMainThreadData()
	{
		return sMainThreadData;
	}

	static void SetMainThreadData(void* inData)
	{
		sMainThreadData = inData;
	}
	...
	static void WrapSleep( Bool16 wrapSleep)
	{
		sWrapSleep = wrapSleep;
	}
#endif
	...
	static cthread_t GetCurrentThreadID()
	{
		return cthread_self();
	}
#endif
